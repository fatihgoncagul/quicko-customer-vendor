          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height:10 ,),
                Text(vendorUserModel.businessName.toString(),style: TextStyle(fontSize: 22, fontWeight: FontWeight.w500),),
                SizedBox(height:15 ,),
                Text("Your application has been sent to shop admin\n Admin will get back to you soon",style: TextStyle(fontSize: 18),textAlign: TextAlign.center,),
                SizedBox(height:10 ,),
